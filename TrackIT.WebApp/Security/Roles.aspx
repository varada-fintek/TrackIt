<%@ Page Language="C#" MasterPageFile="~/master-templates/Layout.Master" AutoEventWireup="true"
    CodeBehind="Roles.aspx.cs" Inherits="ProjMngTrack.WebApp.Security.Roles" Theme="Controls" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            <asp:ValidationSummary ID="RoleAccessvalid" runat="server" ShowMessageBox="True" ShowSummary="False" DisplayMode="List" />
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="DataGridTable">
            	<tr>
                	<td class="DataGridTableLeftHeader"></td>
                    <td class="DataGridTableMiddleHeader">&nbsp;<asp:Label ID="lblRoleHeader" runat="server"></asp:Label><span href="" id="flip1" style="float:right; padding-right:15px; padding-left:10px;"><img src="../images/down-arrow.png" /></span></td>
                    <td class="DataGridTableRightHeader"></td>
                </tr>
                <tr id="panel1">
                	<td colspan="3" class="DataGridTableBody">
                            	
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="DataGridStyleTable">
                            <tr>
                                <td width="15%" class="DataGridStyleText"><asp:Label ID="lblRoleName" runat="server" CssClass="label" ></asp:Label></td>
                                <td width="30%" class="DataGridStyleFormArea">
                                    <asp:TextBox ID="txtRoleName" runat="server" CssClass="textbox" MaxLength="20" TabIndex="1"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvRoleName" runat="server" ControlToValidate="txtRoleName" Text="*" SetFocusOnError="True">
                                    </asp:RequiredFieldValidator>
                                </td>
                                <td width="15%" class="DataGridStyleText"><asp:Label ID="lblModuleName" runat="server" CssClass="label" ></asp:Label></td>
                                <td width="30%" class="DataGridStyleFormArea">
                                    <asp:DropDownList ID="ddlModuleName" runat="server" CssClass="textbox" AutoPostBack="true" TabIndex="2"
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvModuleName" runat="server" ControlToValidate="ddlModuleName"
                                        Text="*" SetFocusOnError="True" InitialValue="">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td width="15%" class="DataGridStyleText"></td>
                                <td width="30%" class="DataGridStyleFormArea">
                                    <asp:CheckBox ID="chkAdmin" runat="server" TextAlign ="Right" TabIndex="3" CssClass="label"/>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" align="center" width="100%" cellpadding="2" cellspacing="2">
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView ID="gvRoleAccess" runat="server" Width="100%" AutoGenerateColumns="false"
                                        SkinID="gridviewSkin" OnRowCreated="RowCreated" AllowSorting="True" OnRowDataBound="gvRoleAccess_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                ...
                <tr>
                    <td align="right" colspan="3">
                        <asp:Button ID="btnSave" runat="server" AccessKey="S" CssClass="buttonSave" TabIndex="3" OnClick="btnSave_Click" />
                        <asp:Button ID="btnClear" runat="server" AccessKey="R" CssClass="buttonClear" CausesValidation="false" TabIndex="4" OnClick="btnClear_Click" />
                        <asp:Button ID="btnCancel" runat="server" AccessKey="C" CssClass="buttonBack" CausesValidation="false" TabIndex="5" OnClick="btnCancel_Click" />
                    </td>
                </tr>
            </table>                            
