...
intellisense.annotate(jQuery.fn, {
  ...
  'CtrlA': function() {
    /// <signature>
    ///   <summary>Bind an event handler to the "CtrlA" JavaScript event, or trigger that event on an element.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'CtrlAin': function() {
    /// <signature>
    ///   <summary>Bind an event handler to the "CtrlAin" event.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'CtrlAout': function() {
    /// <signature>
    ///   <summary>Bind an event handler to the "CtrlAout" JavaScript event.</summary>
    ///   <param name="handler(eventObject)" type="Function">A function to execute each time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
